...
public class ScreenConverter {
     ...
     */
    public ScreenPoint r2s(VectorThree v) {
     ...
     */
    public VectorThree s2r(ScreenPoint p, float z) {
        double x = xr + p.getI() * wr / ws;
        double y = yr - p.getJ() * hr / hs;
        return new VectorThree((float)x, (float)y, z);
    }
     ...
     * @return результирующая трёхмерная точка.
     */
    public VectorThree s2r(ScreenPoint p) {
        return s2r(p, 0);
    }
