...
public final class MatrixFourFactories {
     ...
     */
    public static MatrixFour rotationXYZ(double alpha, int axisIndex) {
        MatrixFour m = one();
     ...
     */
    public static MatrixFour rotationXYZ(double alpha, Axis axis) {
     ...
     */
    public static MatrixFour translation(float x, float y, float z) {
        MatrixFour m = one();
        m.setAt(0, 3, x);
        m.setAt(1, 3, y);
        m.setAt(2, 3, z);
     ...
     * @return матрица переноса
     */
    public static MatrixFour translation(VectorThree v) {
     ...
     */
    public static MatrixFour scale(float factorX, float factorY, float factorZ) {
        MatrixFour m = one();
        m.setAt(0, 0, factorX);
        m.setAt(1, 1, factorY);
        m.setAt(2, 2, factorZ);
     ...
     * @return матрица масштабирования
     */
    public static MatrixFour scale(float factor) {
     ...
     */
    public static MatrixFour centralProjection(float point, int axisIndex) {
        MatrixFour m = one();
        if (axisIndex < 0 || axisIndex > 2)
            return m;
     ...
     * @return Матрица проекции
     */
    public static MatrixFour centralProjection(float point, Axis axis) {
